...
Python oferece uma ampla gama de funcionalidades, mas os conceitos abordados até aqui, como variáveis,
tipos, expressões, funções e controle de fluxo, são fundamentais em qualquer linguagem de programação
e já possibilitam a construção de diversas soluções.
...
\questao[\inlcode{balanceamento}]          {capitulos/ex/balanceamento}
